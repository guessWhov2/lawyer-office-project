...
<div class="nav-item btn-group" role="group" aria-label="Default button group">
    <div class="dropdown btn-group">
        <button class="btn btn-outline-primary border-end-0" type="button" data-bs-toggle="dropdown" 
        aria-expanded="false">
            Status
        </button>
    ...
    <button type="button" class="btn btn-outline-primary"><a href="" style="text-decoration:none;">All Cases</a></button>
    <div class="dropdown btn-group">
        ...
        <li><a class="dropdown-item" href="#">{{ $caseType->name }}</a></li>
        @endforeach
        </ul>
    </div>  
</div>
...
<div class="input-group col flex-shrink-1">
  <div class="btn-group">
  <button type="button" class="btn btn-outline-primary rounded-end-0 dropdown-toggle" data-bs-toggle="dropdown" 
