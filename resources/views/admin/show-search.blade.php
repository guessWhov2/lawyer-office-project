    ...
    <div class="row my-4">
        <div class="accordion accordion-flush" id="accordionFlushParent">
            ...
            <div class="accordion-item">
                ...
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse{{ $legalCase->id }}" 
                aria-expanded="false" aria-controls="flush-collapse{{ $legalCase->id }}">
                    ...
                    <div class="row">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="#" class="btn btn-small btn-outline-primary">User details</a>
                            </div>
                            <div class="card-body">
